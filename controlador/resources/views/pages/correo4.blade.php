<?php
$estudiantes = [
    ['nombre' => 'Randall Alvarez', 'edad' => 21, 'carrera' => 'Arquitectura'],
    ['nombre' => 'Marco Roman', 'edad' => 21, 'carrera' => 'Ingeniería'],
    ['nombre' => 'María López', 'edad' => 19, 'carrera' => 'Ingeniería'],
];
?>

<x-layouts::app :title="__('Correo 4 - Versión 4')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="relative h-full flex-1 overflow-hidden p-6 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-xl">
            <div class="mb-4">
                <h2 class="text-2xl font-bold text-neutral-900 dark:text-neutral-100 italic">Correo 4</h2>
                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Información de Estudiantes de Programación Web 2026 — <span class="font-bold text-neutral-900 dark:text-neutral-100">versión 4</span>
                </p>
            </div>
